...
def testApiWorker_AddLandingPage(filesDir):
    ...
    passFilewithLPandotherRI = os.path.join(filesDir, "api", "passing_wlandingpage_wotherrelatedinfo.xml")
    ...
    data_w_old_landingpage_wotherrelinfo = bytes(readFile(passFilewithLPandotherRI), "utf-8")
    ...
    assert tstWorker._add_landing_page(data_w_old_landingpage_wotherrelinfo,catalog_url) == data_w_landingpage_andotherrelinfo
